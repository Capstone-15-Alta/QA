...
for (int i = 0; i < 5; i++) {
	...
	Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - Masukan Nama'), Nama[i],
		0)
	
	Mobile.tap(findTestObject('Register/android.widget.EditText - Masukkan Email'), 0)
	
	Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - Masukkan Email'), Email[i],
		0)
	
	Mobile.tap(findTestObject('Register/android.widget.EditText - Masukan Password'), 0)
	
	Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - Masukan Password'), Password[i], 0)
